...
export function logStartWatchFile(filename: string): void;
export function logStopWatchFile(): void;
export function logStartWatchDirectory(filename: string, flags: string): void;
export function logStopWatchDirectory(): void;
